...
class FootballApp {
  ...
  renderLeagueSelector(grouped) {
    ...
    const ORDER = [
      'World Cup', 'European', 'England', 'Scotland',
      'Spain', 'Germany', 'Italy', 'France',
      'Other Europe', 'Americas', 'Asia', 'Africa', 'Other'
    ];
  ...
  onLeagueChange() {
    ...
    if (id === 'all') {
      ...
      this.currentLeague = { id: 'wc2026', name: 'FIFA World Cup 2026', category: 'World Cup', country: 'International' };
      this.updateLeagueBadge();
      // Switch to World Cup view
      this.currentView = 'worldcup';
      document.querySelectorAll('[data-view]').forEach(b => b.classList.remove('active'));
      document.querySelector('[data-view="worldcup"]')?.classList.add('active');
      this.render();
    } else {
